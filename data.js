...
const facilities = [
  {
    ...
    measures: { falls: 5.8, wounds: 9, infections: 3, rehosp: 18.5, antipsych: 14.2, uti: 4.1, incidents: 7 },
    heat: { infection: 74, abuse: 68, medpass: 81, wounds: 70, admissions: 77, mdscare: 69 },
    actions: [
    ...
    alerts: [
      ...
      { title: "Abuse policy gap", body: "Two clinical team attestations are still missing.", time: "44 min", severity: "danger" }
    ],
    recommendations: ["Hold 15-minute DON/MDS standup before noon.", "Pull rejected MDS files and assign root cause owner.", "Verify abuse policy attestation completion."]
  },
  {
    id: "lakeside-heights",
    ...
    measures: { falls: 3.7, wounds: 4, infections: 1, rehosp: 14.2, antipsych: 9.1, uti: 2.6, incidents: 2 },
    heat: { infection: 86, abuse: 90, medpass: 88, wounds: 84, admissions: 89, mdscare: 86 },
    actions: [
  ...
  },
  {
    ...
    measures: { falls: 6.2, wounds: 11, infections: 4, rehosp: 21.4, antipsych: 15.7, uti: 5.3, incidents: 9 },
    heat: { infection: 65, abuse: 72, medpass: 69, wounds: 61, admissions: 76, mdscare: 66 },
    actions: [
  ...
  },
  {
    ...
    measures: { falls: 4.9, wounds: 6, infections: 2, rehosp: 16.9, antipsych: 11.4, uti: 3.9, incidents: 5 },
    heat: { infection: 81, abuse: 78, medpass: 80, wounds: 76, admissions: 82, mdscare: 79 },
    actions: [
  ...
  },
  {
    ...
    measures: { falls: 2.8, wounds: 2, infections: 0, rehosp: 11.7, antipsych: 7.6, uti: 1.8, incidents: 1 },
    heat: { infection: 95, abuse: 94, medpass: 96, wounds: 93, admissions: 92, mdscare: 96 },
    actions: [
  ...
  },
  {
    ...
    measures: { falls: 3.1, wounds: 3, infections: 1, rehosp: 13.8, antipsych: 8.8, uti: 2.3, incidents: 2 },
    heat: { infection: 90, abuse: 92, medpass: 86, wounds: 88, admissions: 90, mdscare: 88 },
    actions: [
  ...
  },
  {
    ...
    measures: { falls: 5.1, wounds: 7, infections: 3, rehosp: 17.8, antipsych: 12.6, uti: 4.5, incidents: 6 },
    heat: { infection: 75, abuse: 80, medpass: 73, wounds: 72, admissions: 81, mdscare: 75 },
    actions: [
      { title: "Med pass variance root cause review", owner: "Denise Patel", due: "Today", severity: "danger", type: "Audit" },
      { title: "Care plan meeting audit", owner: "Kara Hughes", due: "Tomorrow", severity: "warn", type: "MDS" }
    ],
    alerts: [
      { title: "Medication administration variance", body: "Med pass audit variance increased on two halls.", time: "27 min", severity: "danger" }
    ],
    recommendations: ["Denise to validate med pass observation findings.", "DON to reconcile med pass variance by shift."]
  },
  {
    id: "willow-springs",
    ...
    measures: { falls: 4.0, wounds: 5, infections: 1, rehosp: 15.6, antipsych: 10.8, uti: 3.1, incidents: 3 },
    heat: { infection: 84, abuse: 88, medpass: 83, wounds: 82, admissions: 86, mdscare: 84 },
    actions: [
  ...
  },
  {
    ...
    measures: { falls: 5.9, wounds: 8, infections: 4, rehosp: 20.2, antipsych: 16.1, uti: 5.0, incidents: 8 },
    heat: { infection: 68, abuse: 74, medpass: 70, wounds: 69, admissions: 73, mdscare: 67 },
    actions: [
  ...
  },
  {
    ...
    measures: { falls: 2.9, wounds: 2, infections: 0, rehosp: 12.6, antipsych: 8.0, uti: 2.0, incidents: 1 },
    heat: { infection: 91, abuse: 93, medpass: 90, wounds: 92, admissions: 91, mdscare: 94 },
    actions: [
